...
//    public int getIs_closed() { return is_closed; }
    public List<VisitDetail> getVisit_details() { return visit_details; }
...
//    public void setEnd_latitude(String end_latitude) { this.end_latitude = end_latitude; }
//    public void setEnd_longitude(String end_longitude) { this.end_longitude = end_longitude; }
//    public void setIs_closed(int is_closed) { this.is_closed = is_closed; }
    public void setVisit_details(List<VisitDetail> visit_details) { this.visit_details = visit_details; }
}
