...
//    AdView mAdView;
    ...
    //    Log.d("Ads SDK Version" ,String.valueOf(MobileAds.getVersion()));
//        MobileAds.setRequestConfiguration(
//                new RequestConfiguration.Builder().setTestDeviceIds(Arrays.asList("206F2D0B7F9BC500D5A7580E34F08C8B"))
//                        .build());
