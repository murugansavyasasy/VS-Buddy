...
public class MemberListAdapter extends RecyclerView.Adapter<MemberListAdapter.MyViewHolder>  {
    ...
    public MemberListAdapter(ArrayList<RequirementModel> datasList1, Context context) {
    ...
    @Override
    public void onBindViewHolder(final MemberListAdapter.MyViewHolder holder, final int position) {
