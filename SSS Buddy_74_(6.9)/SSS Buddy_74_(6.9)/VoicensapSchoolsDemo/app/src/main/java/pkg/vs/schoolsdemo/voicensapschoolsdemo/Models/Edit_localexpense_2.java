...
/**
 * Created by devi on 7/1/2019.
 */

public class Edit_localexpense_2 {
    String BoardLodge,ConvTravel,Food,Fuel,PostageCourier,Printing,Telephone,Misc;

    public Edit_localexpense_2(String board, String ConveyTravel, String FoodBeverage, String FuelPetrol, String postage, String printinig, String Telephone, String Miscellaneous){
