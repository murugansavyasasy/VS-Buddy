...
public class FabActivity extends AppCompatActivity implements CalendarDatePickerDialogFragment.OnDateSetListener  {
    String item, Strid = "0";
    ...
    String Strboard, Strbuisness, Strconv, Strfood, Strfuel, Strpostage, Strprinting, Strtravel, Strmisc,
            Strtourname, Strtourpurpose, Strstartdate, Strenddate, iduser, Strprocessb, Stridtour = "0",
            Strtourplace1, Strtourplace2, Strtourplace3, Strremarks, Strdescription, Strtotaltourexpense, Strprocesstype = "AdvanceTour";
    ...
    int result;
    int date;
    String selDay, selMonth, selYear;
//    int selDay, selMonth, selYear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iduser = SharedPreference_class.getUserid(FabActivity.this);
        Log.d("iduser", iduser);
    ...
    private void addretrofit() {
        ...
        Call<JsonArray> call = apiService.ManageTour(jsonObject);
            ...
            public void onResponse(Call<JsonArray> call, Response<JsonArray> response) {
                ...
                try {
                    ...
                    if (jsonArrayorgList.length() > 0) {
                        ...
                        Toast.makeText(FabActivity.this, "No Records has found", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void alertDialog(String msg) {
        final AlertDialog.Builder dlg = new AlertDialog.Builder(FabActivity.this);
        dlg.setTitle("Alert");
        dlg.setMessage(msg);
    ...
    private void datePicker() {
        ...
        CalendarDatePickerDialogFragment cdp = new CalendarDatePickerDialogFragment()
                ...
                .setOnDateSetListener(FabActivity.this)
