...
//    Call<JsonArray> TodayVisit1(@Body JsonArray jsonObject);
    ...
    Call<JsonObject> updateDailyVisitWithLocation(@Body JsonObject body);
    ...
    @POST("AppDetails/ManageTripDetails")
    Call<JsonObject> ManageTripDetails(@Body JsonObject jsonObject);
    ...
    Call<TripDetails> getOverallTripDetails(@Query("UserId") String userId);
