...
public class ReportActivity extends AppCompatActivity {
    ...
    private void displayTripDetails(List<TripDetails> trips) {
        if (tripAdapter == null) {
            ...
            rvReportList.setAdapter(tripAdapter);
        } else {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    spinnerReport.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        ...
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            int selected_member_id = reportingMembers.get(position).getIdmember();
                            loadTripDetails(String.valueOf(selected_member_id));
                        }
    ...
    private void loadTripDetails(String userId) {
        Log.d("UserID", userId );
        final ProgressDialog dialog = ProgressDialog.show(this, "", "Loading trips...", true);
        Call<List<TripDetails>> call = apiService.getOverallTripDetails(userId);
