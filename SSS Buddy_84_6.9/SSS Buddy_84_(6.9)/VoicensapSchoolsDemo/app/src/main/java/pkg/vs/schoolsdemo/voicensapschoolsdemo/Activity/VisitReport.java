...
public class VisitReport extends AppCompatActivity implements View.OnClickListener {
...
//    static EditText visit_lateUpdate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Lner_Date.setOnClickListener(this);
...
//        checkGPSAndRequestLocation();
        ...
        String isLastTripDate = shpRemember.getString("last_trip_date", "");
        if (isStarted && !isEnded) {
            btnStartVisit.setText("Already Trip Started");
            imgDotStart.setVisibility(View.VISIBLE);
            btnStartVisit.setEnabled(false);
            btnEndVisit.setEnabled(true);
            enableFieldsAfterStart();
        } else {
            btnStartVisit.setText("START FROM HOME");
        ...
        if (todayDate.equals(isLastTripDate)) {
            btnStartVisit.setText("Already Trip Started");
            imgDotStart.setVisibility(View.VISIBLE);
            btnStartVisit.setEnabled(false);
            btnEndVisit.setEnabled(true);
                ...
                new AlertDialog.Builder(VisitReport.this)
                        ...
                        .setPositiveButton("Yes", (dialog, which) -> {
                            ...
                            fetchCurrentLocation((lat, lng, addr) -> {
                                ...
                                editor.putString("last_trip_date", todayDate);
                                editor.putString("START_LOCATION", lat + "," + lng + " (" + addr + ")");
                                editor.apply();

                                btnStartVisit.setText("Trip Started");
...
//        visit_lateUpdate.setText("");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.img_startdate:
                isCalenderClick();
                break;
        }
    }

    private void isCalenderClick() {
...
//                                lbl_resonoflateupdateNewSchool.setVisibility(View.VISIBLE);
    ...
    private void alertWithFinish(String message) {
