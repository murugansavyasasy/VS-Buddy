...
//        shpRemember = getSharedPreferences(SH_USERS, MODE_PRIVATE);
                ...
                new AlertDialog.Builder(VisitReport.this)
                        ...
                        .setPositiveButton("Yes", (dialog, which) -> {
                            ...
                            fetchCurrentLocation((lat, lng, addr) -> {
                                SharedPreferences.Editor visitEditor = shpRemember.edit();
                                visitEditor.putBoolean(KEY_VISIT_STARTED, true);
                                visitEditor.putBoolean(KEY_VISIT_ENDED, false);
                                visitEditor.putString("START_LOCATION", lat + "," + lng + " (" + addr + ")");
                                visitEditor.apply();
                                ...
                                schoolLocations.add(startLocation);
                                String strLat = String.valueOf(lat);
                                String strLng = String.valueOf(lng);
                                sendTripDetails(userId, "start", strLat, strLng);
                                Log.d("VisitReport", "Start Location Added: Lat=" + lat + ", Lng=" + lng + ", Addr=" + addr);
                                Toast.makeText(this, "latitude : " + lat, Toast.LENGTH_SHORT).show();
                                Toast.makeText(this, "longitude : " + lng, Toast.LENGTH_SHORT).show();
                                Toast.makeText(this, "Address: " + addr, Toast.LENGTH_SHORT).show();
                                Toast.makeText(this, "Visit Start", Toast.LENGTH_SHORT).show();
                            });
                        })
                ...
                new AlertDialog.Builder(VisitReport.this)
                        ...
                        .setPositiveButton("Yes", (dialog, which) -> {
                            ...
                            fetchCurrentLocation((lat, lng, addr) -> {
                                ...
                                schoolLocations.add(endLocation);
                                Log.d("VisitReport", "End Location Added: Lat=" + lat + ", Lng=" + lng + ", Addr=" + addr);
                                sendTripDetails(userId, "end", String.valueOf(lat), String.valueOf(lng));
                            });
                        })
                        .setNegativeButton("No", (dialog, which) -> dialog.dismiss())
                        .show();
        ...
        et_schoolname.setOnClickListener(v -> {
            if (!shpRemember.getBoolean(KEY_VISIT_STARTED, false)) {
                Toast.makeText(this, "Start visit first!", Toast.LENGTH_SHORT).show();
            } else {
                et_schoolname.setFocusableInTouchMode(true);
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (linearlayoutlist.size() == 0) {
                    ...
                    if (visit_lateUpdate.getVisibility() == View.VISIBLE && Date_oflate_update.isEmpty()) {
                        visit_lateUpdate.setError("Enter your late update Reason");
                    } else {
                                        ...
                                        if (visit_SpecificStatus.getVisibility() == View.VISIBLE && Status_Specify.isEmpty()) {
                                            ...
                                            adb.setPositiveButton("OK", (dialog, which) -> {
                                                fetchCurrentLocation((lat, lng, addr) -> {
                                                    ...
                                                    String message = "Submitted at: " + addr;
                                                    Toast.makeText(VisitReport.this, message, Toast.LENGTH_LONG).show();
    ...
    private void fetchCurrentLocation(LocationCallbackListener listener) {
        ...
        fusedLocationProviderClient.getLastLocation().addOnSuccessListener(location -> {
            if (location != null) {
                sendLocationToListener(location, listener);
            } else {
                ...
                fusedLocationProviderClient.requestLocationUpdates(locationRequest, new LocationCallback() {
                    ...
                    public void onLocationResult(LocationResult locationResult) {
                        ...
                        if (locationResult != null && !locationResult.getLocations().isEmpty()) {
                            sendLocationToListener(locationResult.getLastLocation(), listener);
                        } else {
                            Toast.makeText(VisitReport.this, "Unable to fetch location", Toast.LENGTH_SHORT).show();
                        }
                    }
            ...
            Log.e("VisitReport", "Error fetching location: " + e.getMessage());
        });
    }
    ...
    private void todayvisitretrofit(String userId, String latitude, String longitude) {
        ...
        Call<JsonObject> call = apiService.updateDailyVisitWithLocation(jsonRequest);
        call.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    try {
                        String Status = response.body().get("result").getAsString();
                        String Reason = response.body().get("resultMessage").getAsString();
                        alert(Reason);
                    } catch (Exception e) {
    ...
    private void sendTripDetails(String userId, String type, String latitude, String longitude) {
        ...
        Log.d("API_REQUEST", "sendTripDetails -> " + jsonObject.toString());

        Voicesnapdemointerface apiService = VoicesnapdemoapiClient.getClient().create(Voicesnapdemointerface.class);
        Call<JsonObject> call = apiService.ManageTripDetails(jsonObject);

        call.enqueue(new Callback<JsonObject>() {
            @Override
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                if (response.isSuccessful() && response.body() != null) {
                    Log.d("API_RESPONSE", "Code: " + response.code() + ", Body: " + response.body().toString());
                } else {
                    ...
                    if (response.errorBody() != null) {
                        try {
                            ...
                            try {
                                ...
                                JsonElement je = JsonParser.parseString(errorJson);
                                String prettyJson = gson.toJson(je);
                                Log.e("API_ERROR_BODY", prettyJson);
                            } catch (Exception e) {
                                Log.e("API_ERROR_BODY", errorJson);
                            }
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
